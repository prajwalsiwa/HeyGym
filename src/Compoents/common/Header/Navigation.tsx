...
const Navigation = () => {
  const Menus = [
    ...
    { name: "Profile", icon: "person-outline", dis: "translate-x-20" },
    { name: "Message", icon: "chatbubble-outline", dis: "translate-x-40" },
    { name: "Photos", icon: "camera-outline", dis: "translate-x-60" },
